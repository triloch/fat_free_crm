...
shared_examples "attach" do
  it "should attach existing asset to the parent asset of different type" do
    ...
    put :attach, xhr:true, params: {id:  @model.id, assets:  @attachment.class.name.tableize, asset_id:  @attachment.id}
...
shared_examples "discard" do
  it "should discard the attachment without deleting it" do
    ...
    post :discard, xhr:true, params: {id:  @model.id, attachment:  @attachment.class.name, attachment_id:  @attachment.id}
